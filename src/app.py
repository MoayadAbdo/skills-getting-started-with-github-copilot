...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice offensive and defensive plays for interschool games",
    ...
    "Swim Club": {
        ...
        "max_participants": 20,
        "participants": ["nora@mergington.edu", "logan@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Drama Club": {
        "description": "Work on acting, stagecraft, and school play productions",
